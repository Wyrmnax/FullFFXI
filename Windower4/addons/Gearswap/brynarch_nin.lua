...
function user_setup()
    ...
    state.WeaponskillMode:options('Normal', 'AttCap', 'Mid', 'Acc')
	...
	send_command('bind ^q input /ja "Yonin" <me>')
	send_command('bind !q input /ja "Innin" <me>')
	send_command('bind @f10 gs c cycle WeaponskillMode')
	send_command('bind !` input /ja "Provoke" <t>')
	send_command('bind !numpad7 input /ma "Doton: San" <t>')
	send_command('bind !numpad8 input /ma "Doton: Ni" <t>')
	send_command('bind !numpad4 input /ma "Raiton: San" <t>')
	send_command('bind !numpad5 input /ma "Raiton: Ni" <t>')
...
function init_gear_sets()
    ...
    --------------------------------------
    sets.TreasureHunter = { head="White rarab cap +1", waist="Chaac Belt", feet="Volte Boots", ammo="Per. Lucky Egg" }
    ...
    sets.precast.FC = {
        ammo="Sapience Orb", --2
    head={ name="Herculean Helm", augments={'Mag. Acc.+15','"Fast Cast"+6','STR+6',}}, --13
    body={ name="Adhemar Jacket +1", augments={'HP+105','"Fast Cast"+10','Magic dmg. taken -4',}}, --10
    hands={ name="Leyline Gloves", augments={'Accuracy+15','Mag. Acc.+15','"Mag.Atk.Bns."+15','"Fast Cast"+3',}}, --8
    legs={ name="Herculean Trousers", augments={'"Fast Cast"+6','Mag. Acc.+5',}}, --6
    feet={ name="Herculean Boots", augments={'"Mag.Atk.Bns."+16','"Fast Cast"+6','Mag. Acc.+13',}}, --6
    ...
    back={ name="Andartia's Mantle", augments={'HP+60','Eva.+20 /Mag. Eva.+20','"Fast Cast"+10','Damage taken-5%',}} --10
    }
    ...
    sets.midcast.Utsusemi =  {
        ammo="Sapience Orb",
    head={ name="Herculean Helm", augments={'Mag. Acc.+15','"Fast Cast"+6','STR+6',}},
    body={ name="Adhemar Jacket +1", augments={'HP+105','"Fast Cast"+10','Magic dmg. taken -4',}},
    hands={ name="Leyline Gloves", augments={'Accuracy+15','Mag. Acc.+15','"Mag.Atk.Bns."+15','"Fast Cast"+3',}},
    legs={ name="Herculean Trousers", augments={'"Fast Cast"+6','Mag. Acc.+5',}},
    ...
    back={ name="Andartia's Mantle", augments={'HP+60','Eva.+20 /Mag. Eva.+20','"Fast Cast"+10','Damage taken-5%',}}
    }
    ...
    body={ name="Herculean Vest", augments={'Mag. Acc.+19 "Mag.Atk.Bns."+19','"Mag.Atk.Bns."+15',}},
    hands={ name="Herculean Gloves", augments={'Mag. Acc.+20 "Mag.Atk.Bns."+20','Weapon skill damage +4%','MND+1','"Mag.Atk.Bns."+11',}},
    legs={ name="Herculean Trousers", augments={'Mag. Acc.+18 "Mag.Atk.Bns."+18','Weapon skill damage +4%','STR+6','Mag. Acc.+12','"Mag.Atk.Bns."+10',}},
    feet={ name="Mochi. Kyahan +3", augments={'Enh. Ninj. Mag. Acc/Cast Time Red.',}},
    neck="Baetyl Pendant",
    ...
    sets.engaged.Haste_35 = set_combine(sets.engaged.MaxHaste, {
		...
		feet={ name="Herculean Boots", augments={'Accuracy+25','"Triple Atk."+4','DEX+6','Attack+7',}}
    })
	...
	sets.precast.WS['Blade: Hi'].AttCap = set_combine(sets.precast.WS, {
        ammo="Yetshila +1",
    head="Hachiya Hatsu. +3",
    body="Ken. Samue +1",
...
moonshade_WS = S{"Blade: Shun", "Blade: Ten"}
function job_post_precast(spell, action, spellMap, eventArgs)
    ...
    if spell.type == 'WeaponSkill' then
		...
		if spell.type == 'WeaponSkill' then
		if (moonshade_WS:contains(spell.english) and (((player.tp<2900) and (player.equipment.main ~= 'Heishi Shorinken')) or (player.tp<2400))) then
