...
---You need to have a minimum of 2 spells in your listpackets = require('packets')
res = require 'resources'
--version 2.0.0.0 final
----------USER IN CODE SETTINGS----------
---Put the spells you want to use in these tables
...
user_settings = {
    user_spells = {
        ...
        Enhancing = T{},
        Ninjutsu = T{},
        Singing = T{'Earth Carol II', 'Water Carol II', "Archer's Prelude", 'Blade Madrigal'},
        Blue = T{},
        Summoning = T{}},
    save_settings = true} --change this to true if you wish to save the last position of your skillup window
sets.brd = {
    wind_inst = {
        range="Gjallahorn"},--put your wind instrument here
    string_inst = {
...
user_settings = {
    user_spells = {
        ...
        Enhancing = T{'Barfira', 'Barblizzara', 'Baraera'},
        Ninjutsu = T{},
        Singing = T{'Earth Carol II', 'Water Carol II', 'Sage Etude', 'Swift Etude'},
        Blue = T{},
        Summoning = T{}},
